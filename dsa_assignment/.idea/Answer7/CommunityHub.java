...
public class CommunityHub extends JFrame {
    ...
    public CommunityHub() {
        ...
        addPostButton = new JButton("Create Post");
        addPostButton.setBackground(buttonBackgroundColor);
        addPostButton.setFocusPainted(false);
        addPostButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String postContent = JOptionPane.showInputDialog(CommunityHub.this, "Share something with the community:");
    ...
    private void addNewPost(String postContent) {
        ...
        likeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(CommunityHub.this, "Liked post!");
        ...
        dislikeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(CommunityHub.this, "Disliked post!");
        ...
        commentButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String comment = JOptionPane.showInputDialog(CommunityHub.this, "Enter your comment:");
                if (comment != null && !comment.isEmpty()) {
                    JOptionPane.showMessageDialog(CommunityHub.this, "Commented: " + comment);
